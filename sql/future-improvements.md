# Future SQL / Reporting Improvements

## Overview

Several improvements are planned for the SQL and reporting layer.
...
- add clear record identifiers where needed
- improve query reliability
- reduce dependency on unclear legacy logic
- improve maintainability of reporting queries

---

## Engineering Goal

The goal is to make the database and reporting layer easier to maintain and more reliable for production analysis and ERP integration.
